...
func WriteDeploymentInstructions(c *types.Config) {
	...
	scriptFile.WriteString("if [ \"$WAZUH_SERVER\" = \"localhost\" ]; then\n")
	scriptFile.WriteString("  cp -v 60000-windows_channel_parent.xml 100000-sysmon_new_events.xml 109970-windows_builtin_channels_parent.xml 200000-windows_powershell_parent.xml 200100-windows_eventid_parent.xml 210000-linux_auditd_parent.xml /var/ossec/etc/rules/ 2>/dev/null || true\n")
	scriptFile.WriteString("else\n")
	scriptFile.WriteString("  scp 60000-windows_channel_parent.xml 100000-sysmon_new_events.xml 109970-windows_builtin_channels_parent.xml 200000-windows_powershell_parent.xml 200100-windows_eventid_parent.xml 210000-linux_auditd_parent.xml $WAZUH_USER@$WAZUH_SERVER:/var/ossec/etc/rules/ 2>/dev/null || true\n")
	scriptFile.WriteString("fi\n\n")
	...
	scriptFile.WriteString("  chown wazuh:wazuh /var/ossec/etc/rules/*-sigma_*.xml /var/ossec/etc/rules/600*.xml /var/ossec/etc/rules/1000*.xml /var/ossec/etc/rules/2000*.xml /var/ossec/etc/rules/2100*.xml\n")
	scriptFile.WriteString("  chmod 640 /var/ossec/etc/lists/sigma_*\n")
	scriptFile.WriteString("  chmod 640 /var/ossec/etc/rules/*-sigma_*.xml /var/ossec/etc/rules/600*.xml /var/ossec/etc/rules/1000*.xml /var/ossec/etc/rules/2000*.xml /var/ossec/etc/rules/2100*.xml\n")
	scriptFile.WriteString("else\n")
	scriptFile.WriteString("  ssh $WAZUH_USER@$WAZUH_SERVER \"chown wazuh:wazuh /var/ossec/etc/lists/sigma_* && chown wazuh:wazuh /var/ossec/etc/rules/*-sigma_*.xml /var/ossec/etc/rules/600*.xml /var/ossec/etc/rules/1000*.xml /var/ossec/etc/rules/2000*.xml /var/ossec/etc/rules/2100*.xml && chmod 640 /var/ossec/etc/lists/sigma_* && chmod 640 /var/ossec/etc/rules/*-sigma_*.xml /var/ossec/etc/rules/600*.xml /var/ossec/etc/rules/1000*.xml /var/ossec/etc/rules/2000*.xml /var/ossec/etc/rules/2100*.xml\"\n")
	scriptFile.WriteString("fi\n\n")
